...
- **古风前端「临水轩」MVP 已通**：厅堂五扇屏风（桃花→春水可入，波场水面为自研重写）/ 竹简对话台接通 `/v1/chat` / 时辰光色与风值；`npm run dev:xuan`（端口 7101），设计见 [docs/临水轩前端技术设计文档-v1.0.md](docs/临水轩前端技术设计文档-v1.0.md)。
...
- **冲突响应评测**：22/22（100%）。
- **LoCoMo 事实底盘**：0.670，双口径过线（v0.2.0 口径，glm-5.3 作答判分），高于 mem0 参照宏平均。
